  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-2xl border border-maroon/10 p-7 md:p-9">
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <div>
          <label htmlFor="r-email" className="text-xs text-sandalwood">Email (optional)</label>
          <input
            id="r-email"
            name="email"
            type="email"
      ...
      <div className="mt-5">
        <label htmlFor="r-relationship" className="text-xs text-sandalwood">You are a</label>
        <select
          id="r-relationship"
          name="relationship"
      ...
      <div className="mt-5">
        <span className="text-xs text-sandalwood">Your rating</span>
      ...
      <div className="mt-5">
        <label htmlFor="r-message" className="text-xs text-sandalwood">Your review</label>
        <textarea
          id="r-message"
          name="message"
          required
      ...
      <p className="mt-4 text-xs text-sandalwood">
