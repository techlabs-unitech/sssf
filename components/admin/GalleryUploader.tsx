...
export default function GalleryUploader() {
  ...
  return (
    <form
      ...
      className="rounded-2xl border border-maroon/10 p-7 md:p-9"
    >
      <div className="grid gap-5 sm:grid-cols-[180px_1fr]">
        <div className="relative flex h-36 items-center justify-center overflow-hidden rounded-xl border border-dashed border-maroon/20 bg-ivory-soft">
          {preview ? (
        ...
        <div className="flex flex-col gap-4">
          <div>
            <label htmlFor="g-file" className="text-xs text-sandalwood">
              Image file
            </label>
            <input
              id="g-file"
              ...
              className="mt-2 w-full text-sm text-sandalwood file:mr-4 file:rounded-lg file:border-0 file:bg-marigold file:px-4 file:py-2 file:text-sm file:font-medium file:text-white"
            />
          </div>
          <div>
            <label htmlFor="g-alt" className="text-xs text-sandalwood">
