  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="rounded-2xl border border-maroon/10 p-7 md:p-9">
        ...
        <div className="mt-4">
          <label htmlFor="custom-amount" className="text-xs text-sandalwood">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          <div>
            <label htmlFor="name" className="text-xs text-sandalwood">Full name</label>
            <input
              id="name"
              type="text"
              required
          ...
          <div>
            <label htmlFor="email" className="text-xs text-sandalwood">Email</label>
            <input
              id="email"
              type="email"
              required
        ...
        <div className="mt-4">
          <label htmlFor="address" className="text-xs text-sandalwood">Address for receipt</label>
          <input
            id="address"
            type="text"
            required
        ...
        <div className="mt-4">
          <label htmlFor="pan" className="text-xs text-sandalwood">PAN (optional for receipt and verification)</label>
          <input
            id="pan"
            type="text"
            value={pan}
