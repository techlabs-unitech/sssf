        ...
        {slides.length > 1 && (
          <>
            <button
              ...
              className="absolute left-3 top-1/2 -translate-y-1/2 rounded-full bg-ivory/80 p-2 text-maroon shadow-md backdrop-blur transition hover:bg-ivory"
            >
            ...
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 rounded-full bg-ivory/80 p-2 text-maroon shadow-md backdrop-blur transition hover:bg-ivory"
            >
