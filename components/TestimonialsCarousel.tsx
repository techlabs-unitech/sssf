            ...
            <div key={review.id} className="w-full shrink-0 px-1">
              <figure className="mx-auto flex max-w-2xl flex-col items-center rounded-2xl border border-maroon/10 bg-white/60 p-8 text-center shadow-[0_12px_35px_rgba(11,15,140,0.06)] md:p-10">
                ...
                <figcaption className="mt-6">
                  ...
                  <p className="mt-1 text-xs tracking-wide uppercase text-sandalwood">
                    {review.relationship}
                  </p>
                  {review.rating ? (
                    <div
        ...
        {reviews.length > 1 && (
          <>
            <button
              ...
              className="absolute left-0 top-1/2 -translate-y-1/2 rounded-full bg-ivory/80 p-2 text-maroon shadow-md backdrop-blur transition hover:bg-ivory md:-left-4"
            >
            ...
            <button
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 rounded-full bg-ivory/80 p-2 text-maroon shadow-md backdrop-blur transition hover:bg-ivory md:-right-4"
            >
