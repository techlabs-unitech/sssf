  ...
  return (
    <section className="container-seva flex min-h-[70vh] items-center justify-center py-16">
      <form
        ...
        className="w-full max-w-sm rounded-2xl border border-maroon/10 p-8"
      >
        <h1 className="font-display text-2xl text-maroon">Admin sign in</h1>
        <p className="mt-2 text-sm text-sandalwood">
          Enter the admin password to manage the gallery.
        </p>

        <div className="mt-6">
          <label htmlFor="password" className="text-xs text-sandalwood">
            Password
          </label>
          <input
            id="password"
